...
public abstract class Ship implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1663653524873089218L;
	 ...
	 */
	public double fuelConsumed(double duration){//if throws exception returns -1
		try {
			if(duration < 0)
	 ...
	 * @return fuel consumed in this trip
	 */
	public double fuelConsumed(double distance, double average_speed){//if throws exception returns -1
		try {
			if(distance < 0 || average_speed < 0)
				throw new IllegalArgumentException();
			else
	 ...
	 * @return fuel consumed in this trip
	 */
	public double fuelConsumed(String departure, String arrival){//if throws exception returns -1
